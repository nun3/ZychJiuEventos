  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#20BA5A] transition-all duration-300 flex items-center justify-center z-40 hover:scale-110"
        ...
        whileTap={{ scale: 0.95 }}
      >
        <MessageCircle size={28} className="sm:w-8 sm:h-8 md:w-10 md:h-10" />
      </motion.button>
    </>
  )
}
