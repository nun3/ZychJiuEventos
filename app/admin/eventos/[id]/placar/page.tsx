      ...
      <div className="container mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-md p-6">
          <div className="text-center py-12">
            <FiBarChart size={64} className="mx-auto text-gray-400 mb-4" />
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Placar e Pontuação</h2>
            <p className="text-gray-600">
              Visualize o placar geral do evento, pontuação por equipe e classificações.
            </p>
