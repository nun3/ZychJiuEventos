    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-md p-6">
          ...
          {/* Conteúdo da Aba N° ou Nome */}
          {activeTab === 'numero' && (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2 uppercase">
                    N° da(s) Inscrição(ões)
                  </label>
                  <input
                    type="text"
              ...
              <div className="mt-6">
                <button className="w-full md:w-auto inline-flex items-center gap-2 bg-gradient-to-r from-[#0C3049] to-blue-800 text-white font-bold py-3 px-6 rounded-lg hover:shadow-lg transition">
                  <FiSearch size={20} />
                  Pesquisar
                </button>
              </div>
